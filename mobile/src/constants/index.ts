...
export const USERS_ON_SWIPPING = [
  ...
  {
    coverSrc:
      'https://gestion.pe/resizer/ZSNKdYFYGtHKMgRy0uhGhSfFswU=/1200x800/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/SMTXVEJFZRHNZDPDBI4SWLFM24.jpg',
    name: 'Elon Musk',
    age: '52',
    description: "World's CEO",
    distance: '5.5mil',
  },
];
